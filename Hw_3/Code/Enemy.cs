...
namespace Asteroids
{
    internal abstract class Enemy : MonoBehaviour
    {
        ...
        internal static IEnemyFactory Factory;
        ...
        public static EnemyCylinder CreateEnemyCylinder(Health hp)
        {
            {
                var enemy = Instantiate(Resources.Load<EnemyCylinder>("EnemyCylinder"));
